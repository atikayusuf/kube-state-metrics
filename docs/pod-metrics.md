...
| kube_pod_init_container_completion_time | Gauge | Completion time in unix timestamp for an init container | seconds |`container`=&lt;container-name&gt; <br>  `pod`=&lt;pod-name&gt; <br> `namespace`=&lt;pod-namespace&gt; <br> `uid`=&lt;pod-uid&gt; | STABLE | - |
...
| kube_pod_init_container_state_started | Gauge | Start time in unix timestamp for an init container | seconds |`container`=&lt;container-name&gt; <br>  `pod`=&lt;pod-name&gt; <br> `namespace`=&lt;pod-namespace&gt; <br> `uid`=&lt;pod-uid&gt; | STABLE | - |
